...
public:
    RenderDeviceD3DBase(IMemoryAllocator &RawMemAllocator, 
                        ...
                        size_t PSOSize,
                        size_t SRBSize) : 
        RenderDeviceBase<BaseInterface>(RawMemAllocator, TextureObjSize, TexViewObjSize, BufferObjSize, BuffViewObjSize, ShaderObjSize, SamplerObjSize, PSOSize, SRBSize)
    {
