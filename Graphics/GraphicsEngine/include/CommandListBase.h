...
/// Template class implementing base functionality for a CommandList object.

/// \tparam BaseInterface - base interface that this class will inheret 
///                         (Diligent::ICommandListD3D11 or Diligent::ICommandListGL).
...
public:
	...
	/// \param SamDesc - CommandList description.
