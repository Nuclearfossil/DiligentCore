...
public:
    ...
    /// Returns a pointer to the ID3D12PipelineState interface of the internal Direct3D11 object.
    
    /// The method does *NOT* call AddRef() on the returned interface,
    /// so Release() must not be called.
    virtual ID3D12PipelineState *GetD3D12PipelineState() = 0;

    virtual ID3D12RootSignature *GetD3D12RootSignature() = 0;
};
